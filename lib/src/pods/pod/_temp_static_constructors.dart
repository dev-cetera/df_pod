...
ChildPod<T1, T2> _tempFromMany<T1, T2>(
...
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom2<T, T1, T2>(
...
/// via [reducer]. Optionally provide [updateParents] to define how parent Pods
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom3<T, T1, T2, T3>(
...
/// via [reducer]. Optionally provide [updateParents] to define how parent Pods
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom4<T, T1, T2, T3, T4>(
...
/// via [reducer]. Optionally provide [updateParents] to define how parent Pods
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom5<T, T1, T2, T3, T4, T5>(
...
/// via [reducer]. Optionally provide [updateParents] to define how parent Pods
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom6<T, T1, T2, T3, T4, T5, T6>(
...
/// via [reducer]. Optionally provide [updateParents] to define how parent Pods
/// should be updated when this Pod changes.
ChildPod<dynamic, T> _tempFrom7<T, T1, T2, T3, T4, T5, T6, T7>(
...
ChildPod<T1, T2> _createTempChildPod<T1, T2>({
